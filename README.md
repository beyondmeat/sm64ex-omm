...
```diff
- IMPORTANT NOTICE:
- Cloning the `sm64ex-omm` repository from beyondmeat's github is the only way to get the builder.
...
- **Windows**:
  ...
  - The first time, install the builder by cloning the *master* branch with this command:<br>`git clone https://github.com/beyondmeat/sm64ex-omm.git -b master`
...
- [Patch file](https://raw.githubusercontent.com/beyondmeat/sm64ex-omm/master/patch/omm.patch)
- [Coop LUA mod: OMM Moves](https://github.com/beyondmeat/sm64ex-omm/raw/master/coop/omm-moves.zip)
- [Coop LUA mod: OMM Cappy](https://github.com/beyondmeat/sm64ex-omm/raw/master/coop/omm-cappy.zip)
...
- Each character has different properties and moves:
  ...
  - **Peach**: same properties as Mario, plus extra moves from *Super Princess Peach*. See [Version 6.0.0](https://github.com/beyondmeat/sm64ex-omm/tree/master#peach).
...
- See [Speedrunning](https://github.com/beyondmeat/sm64ex-omm/tree/master#speedrunning) for more details.
