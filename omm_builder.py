...
if __name__ == "__main__":
    ...
    VERSIONS = {
        ...
        "sm74": { "name": "Super Mario 74",            "repo": "https://github.com/beyondmeat/sm64ex-omm.git -b sm74",      "dependency": "",          "args": [] },
        "smsr": { "name": "Super Mario Star Road",     "repo": "https://github.com/beyondmeat/sm64ex-omm.git -b smsr",      "dependency": "",          "args": [] },
    ...
    # Check builder
    os.system("wget --no-check-certificate --no-cache --no-cookies https://raw.githubusercontent.com/beyondmeat/sm64ex-omm/master/omm_builder.py -O omm_builder.version -q || rm -f omm_builder.version")
    ...
    if args["NO_UPDATE"]:
        ...
        os.system("wget --no-check-certificate --no-cache --no-cookies https://raw.githubusercontent.com/beyondmeat/sm64ex-omm/nightly/omm.mk -O omm.version -q || rm -f omm.version")
    ...
    if not upToDate or not os.path.isdir(OMM_PATCH_DIR):
        ...
        ommRepository = "https://github.com/beyondmeat/sm64ex-omm.git -b nightly"
